  ...
  - banner [ref=e6]:
    ...
    - generic [ref=e41]:
      - generic [ref=e44]:
        ...
        - generic [ref=e48]:
          - generic [ref=e49]:
            - link "602-916-1409" [ref=e51] [cursor=pointer]:
              - /url: tel:+16029161409
    ...
    - generic [ref=e503]:
      - generic [ref=e506]:
        - generic [ref=e507]:
          ...
          - generic [ref=e511]:
            - generic [ref=e513]: 
            - link "602-916-1409" [ref=e514] [cursor=pointer]:
              - /url: tel:+16029161409
          - generic [ref=e516]:
            - generic [ref=e517]:
              - generic [ref=e518]: 
...
```ts
  ...
  34 |   if (
  35 |     staging.width !== live.width ||
  36 |     staging.height !== live.height
  37 |   ) {
  38 | 
> 39 |     throw new Error(
     |           ^ Error: Screenshot dimensions do not match
  40 |       'Screenshot dimensions do not match'
  41 |     );
  42 |   }
  43 | 
  44 |   const { width, height } = staging;
  45 | 
  46 |   const diff = new PNG({
  47 |     width,
  48 |     height,
  49 |   });
  50 | 
  51 |   const mismatchedPixels = pixelmatch(
  52 |     staging.data,
  53 |     live.data,
  54 |     diff.data,
  55 |     width,
  ...
  62 |   fs.writeFileSync(
  63 |     diffPath,
  64 |     PNG.sync.write(diff)
  65 |   );
  66 | 
  67 |   const totalPixels = width * height;
  68 | 
  69 |   const mismatchPercentage =
  70 |     (mismatchedPixels / totalPixels) * 100;
  71 | 
  72 |   return {
  73 |     mismatchedPixels,
  74 |     mismatchPercentage,
  75 |   };
  76 | }
```