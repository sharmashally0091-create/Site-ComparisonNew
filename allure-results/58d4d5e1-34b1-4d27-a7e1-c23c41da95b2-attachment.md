  ...
  - banner [ref=e6]:
    ...
    - generic [ref=e41]:
      - generic [ref=e44]:
        ...
        - generic [ref=e48]:
          - generic [ref=e49]:
            - link "602-916-1092" [ref=e51] [cursor=pointer]:
              - /url: tel:+16029161092
    ...
    - generic [ref=e78]:
      ...
      - generic [ref=e377]:
        ...
        - generic [ref=e380]:
          ...
          - generic [ref=e391]:
            - group "4 / 5" [ref=e392]:
              - paragraph [ref=e393]: Morehart is a family-owned business that strives to provide the best service for customers and clients. The owner Josh Is a hard-working individual who’s not afraid to go to work in the field with his team to ensure the best service possible. I highly recommend this company.
              - generic [ref=e394]:
                - strong [ref=e395]: Paul D.
                - paragraph
            - group "5 / 5" [ref=e396]:
              - paragraph [ref=e397]: I have been a customer for more than 10 years and always have excellent service. Brian, John, Josh, and the rest of their staff are great. I recommend Morehart to everyone who asks about A/C, heating, and hot water systems. These guys are awesome!
              - generic [ref=e398]:
                - strong [ref=e399]: Roger R.
                - paragraph
            - group "1 / 5" [ref=e400]:
              - paragraph [ref=e401]: Our A/C unit stopped cooling around 4:30 to 5pm. I called Morehart around 5:30pm & their service tech, John, was here by 6pm. He had our system running again within an hour. He was very pleasant & professional. We'll always use Morehart.
              - generic [ref=e402]:
                - strong [ref=e403]: Carolyn M.
                - paragraph
            - group "2 / 5" [ref=e404]:
              - paragraph [ref=e405]: Thomas was awesome! He showed up in under 45 minutes after hours and was able to diagnose the issue within 30 minutes! Mayley was super sweet and communicated with us while she worked on getting Thomas out to us. So grateful we use such an awesome company for our HVAC issues.
              - generic [ref=e406]:
                - strong [ref=e407]: Amanda K.
                - paragraph
            - group "3 / 5" [ref=e408]:
              - paragraph [ref=e409]: I have relied on and trusted Brian Sturgeon at Morehart for all of my residential and commercial air conditioning and heating needs for the past 14 years. Brian is great, he's always on time, friendly, and keeps me informed of my unit’s status and any issues he finds. Morehart also offers great service plans to keep your system running.
              - generic [ref=e410]:
                - strong [ref=e411]: Michelle B.
                - paragraph
          - generic [ref=e412]:
    ...
    - generic [ref=e503]:
      - generic [ref=e506]:
        - generic [ref=e507]:
          ...
          - generic [ref=e511]:
            - generic [ref=e513]: 
            - link "602-916-1092" [ref=e514] [cursor=pointer]:
              - /url: tel:+16029161092
          - generic [ref=e516]:
            - generic [ref=e517]:
              - generic [ref=e518]: 
...
> 10  |   await page.waitForLoadState('networkidle');
  ...
  26  | 
  27  |   // Wait for all images
  28  |   await waitForImages(page);
  29  | 
  30  |   // Wait for fonts
  31  |   await waitForFonts(page);
  32  | 
  33  |   // Final stabilization
  34  |   await page.waitForTimeout(2000);
  35  | }
  36  | 
  37  | async function disableAnimations(page: Page) {
  38  | 
  ...
  46  |         caret-color: transparent !important;
  47  |       }
  48  | 
  49  |       html {
  ...
  54  | }
  55  | 
  56  | async function hideIgnoredElements(page: Page) {
  57  | 
  58  |   await page.evaluate((selectors) => {
  59  | 
  60  |     selectors.forEach((selector) => {
  61  | 
  62  |       document.querySelectorAll(selector).forEach((el) => {
  63  | 
  64  |         (el as HTMLElement).style.display = 'none';
  65  | 
  66  |       });
  67  |     });
  68  | 
  ...
  70  | }
  71  | 
  72  | async function stopAnimationsAndSliders(page: Page) {
  73  | 
  74  |   await page.evaluate(() => {
  75  | 
  76  |     // Swiper
  77  |     document.querySelectorAll('.swiper').forEach((el: any) => {
  78  |       el.swiper?.autoplay?.stop?.();
  79  |     });
  80  | 
  81  |     // Slick slider
  82  |     document.querySelectorAll('.slick-slider').forEach((el: any) => {
  83  |       el.slick?.pause?.();
  84  |     });
  85  | 
  86  |     // Videos
  87  |     document.querySelectorAll('video').forEach((video: any) => {
  88  |       video.pause();
  89  |     });
  90  |   });
  91  | }
  92  | 
  93  | async function autoScroll(page: Page) {
  94  | 
  ...
  100 | 
  101 |       const distance = 500;
  102 | 
  103 |       const timer = setInterval(() => {
  104 | 
  105 |         window.scrollBy(0, distance);
  106 | 
  107 |         totalHeight += distance;
  108 | 
  109 |         if (totalHeight >= document.body.scrollHeight) {
  110 | 
```