import * as _$openapi_fetch0 from "openapi-fetch";
...
interface paths {
  ...
  "/projects/{owner}/{project}/builds/{buildNumber}/reviews": {
    ...
    get?: never;
    put?: never; /** Create a review on a specified build */
...
interface components {
  schemas: {
    ...
    ScreenshotInput: {
      ...
      threshold?: number | null; /** @default image/png */
      contentType: string;
     ...
     * @example 42
     */
    BuildNumber: string; /** @description Build */
    Build: {
    ...
    requestBody?: {
      content: {
        "application/json": {
          ...
          branch: components["schemas"]["GitBranch"]; /** @description Keys of screenshot files */
          screenshotKeys: components["schemas"]["Sha256Hash"][]; /** @description Keys of Playwright trace files */
...
declare function createClient(options?: {
  baseUrl?: string;
  authToken?: string;
}): _$openapi_fetch0.Client<paths, `${string}/${string}`>;
 ...
 * Handle API errors.
 */
declare function formatAPIError(error: components["schemas"]["Error"]): string;
/**
 * Handle API errors.
 */
